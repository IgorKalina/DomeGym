...
class TestDeleteSubscription:
    ...
    async def test_when_subscription_not_exists_should_return_404(self) -> None:
        # Act
        response, response_data = await self._subscriptions_api.delete(subscription_id=constants.common.NON_EXISTING_ID)
    ...
    @pytest.mark.asyncio
    async def test_when_subscription_exists_should_delete_subscription(
